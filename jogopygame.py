...
nomeJogador2 = menufonte.render("Jogador2:" + nome2,True,(255,255,255))
...
while continuar and digitarNome2:
    ...
    for event in pygame.event.get():
        if event.type == QUIT:
            ...
            teclado = pygame.key.get_pressed()
            nome2 = nome2 + event.unicode
            nomeJogador2 = menufonte.render("Jogador2:" + nome2,True,(255,255,255))
            pygame.display.flip()
            if teclado[K_BACKSPACE]:
                numeroNome2 = len(nome2)
                nomeNovo2 = nome2[0:numeroNome2 - 2]
                nome2= nomeNovo2
                nomeJogador2 = menufonte.render("Jogador2:" + nome2,True,(255,255,255))
                pygame.display.flip()
            ...
            if teclado[K_RETURN]:
                numeroNome2 = len(nome2)
                nomeNovo2 = nome2[0:numeroNome2 - 1]
                nome2= nomeNovo2
                digitarNome2 = False
    
    pygame.display.flip()
digitarNome3 = True
while continuar and digitarNome3:
    tela.blit(background,(0,0))
...
if salvar == "SIM":
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                if teclado[K_RETURN]:
                    ...
                    import funpygame
                    funpygame.jogar(jogador1,jogador2,partida,superTrunfo,nome1,nome2,nomedoarquivo)
        pygame.display.flip()
    ...
    del nomedoarquivo
    import funpygame
    funpygame.jogar(jogador1,jogador2,partida,superTrunfo,nome1,nome2,"")
